...
/** 
 * @ClassName: Clockwised 
 * @Description: Clockwised comparator
 * @author makebono
 * @date 2017年11月17日 下午5:42:47 
 *  
 */
public class ClockwisedScan<T> implements Comparator<Vertex<T>> {
    private final Vertex<T> minimumY;

    public ClockwisedScan() {
        this.minimumY = new Vertex<T>(1, null, 0, 0);
    }

    public ClockwisedScan(final Vertex<T> minimumY) {
