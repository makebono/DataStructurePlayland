        ...
        if (target == null) {
            ...
            if (sideKick.compare(data, tempRoot.getData()) > 0) {
                ...
                if (tempRoot.isLeaf()) {
                    ...
                    // subtree. And then delete the left maximum. This could create disasters when in a relatively
                    // massive tree. But you can leave the disaster to recursion deletion call. Just need to understand
                    // this idea.
                } else {
